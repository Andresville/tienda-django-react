    ...
    >
      <div className="card-body d-flex flex-column">
        ...
        <p className="mb-1">
          ...
          <span className="fw-bold" style={{ color: STYLES.BUTTON_HOVER }}>
        ...
        <p className="mb-1">
          ...
          <span
            className="fw-bold"
            style={{
              color: product.discount > 0 ? "green" : STYLES.TEXT_COLOR,
            }}
          >
            {product.discount}%
          </span>
  ...
  const handleDelete = async (id) => {
    ...
    if (
      ...
      try {
        ...
        alert(
          "Error al eliminar el producto. " + (err.response?.data?.error || "")
        );
      }
    }
  };
    ...
    <div>
      ...
      {!isUserAdmin && (
        <small className="text-muted">
          Estás visualizando el catálogo. Solo los Administradores pueden crear,
          editar o eliminar.
        </small>
      )}
    </div>
